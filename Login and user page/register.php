...
<body class="register-page">
    <div>
        ...
        <form name="registrationForm" method="post" onsubmit="return validateForm()">
           ...
           <div class="textbox">
            ...
            <p class="login-link"><center>Already have an account?<a href="login.php">Login</a></center></p>
        </form>
    </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($password !== $confirm_password) {
            ...
            $sql = "INSERT INTO users_data (firstname, lastname, email, phoneno, username, password) 
